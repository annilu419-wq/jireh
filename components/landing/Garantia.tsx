      ...
      >
        <motion.div variants={item}>
          ...
          <Hairline surface="surface" className="shadow-[var(--shadow-1)]">
            <div className="flex items-start gap-4 px-6 py-8 sm:px-8">
              <span
                aria-hidden="true"
                className="flex size-15 shrink-0 items-center justify-center rounded-[var(--radius-button)] border border-[color-mix(in_oklab,var(--accent)_22%,transparent)] bg-[var(--chip-bg)]"
              >
                <Icono size={32} strokeWidth={1.8} color="var(--accent)" aria-hidden="true" />
              </span>
              <div className="min-w-0">
                <h2 className="text-[20px] font-bold leading-tight [font-family:var(--font-display)]">
                ...
                {pisoLegal && (
                  <p className="mt-3 flex items-center gap-1.5 text-[13px] text-[var(--text-tertiary)]">
